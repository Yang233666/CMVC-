...
class CMVC_plus_Main(object):
    ...
    def read_triples(self):
        ...
        elif 'NYTimes2018' in args.dataset:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-data', dest='dataset', default='NYTimes2018', help='Dataset to run CMVC+ on')
    parser.add_argument('-split', dest='split', default='CL_newyorktimes_openie_arts.json', help='Dataset split for evaluation')
